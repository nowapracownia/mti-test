...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '202103171_MTI_task_2570713ab7ee673b2699_20210317113532_archive.zip';
	const ARCHIVE_SIZE		 = '30041554';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2570713-17113532';
    const SECONDARY_PACKAGE_HASH = '9ba11f5-17113532';
	const VERSION			 = '1.4.0';
